...
local COL_X = { status = 0, name = 22, level = 168, class = 218, spec = 314, activity = 420, time = 596, actions = 848 }
local COL_W = { status = 18, name = 140, level = 44, class = 90, spec = 100, activity = 170, time = 246, actions = 90  }
